...
mkdir -p ../sources/build/nv_codec_headers
...
(
cd ../build/nv_codec_headers
git archive --format=tar HEAD | xz -c - > ../../sources/build/nv_codec_headers/nv_codec_headers-src-$(git describe --tags).${ARCHIVE_TYPE}
)
